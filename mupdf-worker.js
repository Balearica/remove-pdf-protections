...
Module.onRuntimeInitialized = function () {
	...
	mupdf.saveDocument = Module.cwrap('saveDocument', 'null', ['number']);
	mupdf.getSaveDocumentData = Module.cwrap('getSaveDocumentData', 'number', []);
	mupdf.getSaveDocumentSize = Module.cwrap('getSaveDocumentSize', 'number', []);
...
mupdf.save = function (doc) {
	mupdf.saveDocument(doc);
	const n = mupdf.getSaveDocumentData();
	const p = mupdf.getSaveDocumentSize();
